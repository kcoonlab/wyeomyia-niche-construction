...
plot(ggemmeans(binomial_model_survival,terms="Log_CFU_Eggs [all]"),show.title= FALSE, line.size=1) + theme_cowplot() + xlab("CFU per mL (log 10)") + ylab("Proportion survival")
